...
export const CreateNodeModal = ({ setIsModalOpen, isModalOpen }: CreateNodeModalProps) => {
  ...
  const { register, handleSubmit, reset } = useForm<CreateNodeType>();
        ...
        <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
          <form onSubmit={handleSubmit(onSubmit)} className={styles.container}>
            ...
            <select
              ...
              {...register('nodeShape', { required: true })}
            ...
            {(selectedVariant === NodeUiVariants.Rectangle || selectedVariant === NodeUiVariants.RectangleOutlined) && (
              <div className={styles.container}>
                <input className={styles.input} type={'number'} {...register('topDotsCount')} />
                ...
                {/*<select {...register('rightDotsType')}>{handleTypes()}</select>*/}
              </div>
            )}
            <label>Height</label>
